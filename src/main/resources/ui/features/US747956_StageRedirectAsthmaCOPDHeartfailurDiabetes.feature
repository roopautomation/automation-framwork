...
@URLs
Feature: STG URL Redirects Asthma, COPD, Heart, Diabetes, CAD,
  ...
  Scenario Outline: Spine and Joint Solution (sjs) URLs redirect
    ...
    Examples: 
      ...
      | https://stg-myoptum.phs.com/sjs | https://stg-myoptum.phs.com/content/phs/en/phs/sjs.html | Spine and Joint Solution |
